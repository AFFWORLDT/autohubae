...
const data= portalCalls
    ...
    const filteredData = portalCalls.filter(item => {
    ...
    <section
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          <h1 className={styles.title}>Phone Views Analytics</h1>
          <p className={styles.subtitle}>Total Phone Views: {filteredData.length} | Last Updated: {new Date().toLocaleDateString()}</p>
        </div>
          ...
          <table className={styles.table}>
            <thead className={styles.thead}>
              <tr>
                ...
                <th className={styles.headerCell}>Views</th>
              </tr>
            </thead>
  ...
  {filteredData?.map((item, index) => (
    <tr key={index} className={styles.row}>
      ...
      <td className={styles.cell}>
        <span className={styles.viewCount}>{item.phone_views}</span>
      </td>
    </tr>
  ))}
</tbody>
