      ...
      >
        ...
        <div className={styles.container}>
          <div className={styles.header}>
            <h1 className={styles.title}>SMS Views Analytics</h1>
            <p className={styles.subtitle}>Total SMS CLICK: {filteredData.length} | Last Updated: {new Date().toLocaleDateString()}</p>
          </div>
            ...
            <table className={styles.table}>
              <thead className={styles.thead}>
                <tr>
                  ...
                  <th className={styles.headerCell}>Click</th>
                </tr>
              </thead>
